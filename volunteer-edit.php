...
if(!empty($_POST)){
  ...
  $ke = $db->prepare("UPDATE `volunteers` SET `active` = :active, `street1` = :street1, `street2` = :street2, `town` = :town, `county` = :county, `postcode` = :postcode, `phone` = :phone
  WHERE `id` = :id");
              ...
              <form method="post">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-2">
                    <input type="text" class="form-control" id="postcode" name="postcode" placeholder="Postcode"  value="<?= $k['postcode']; ?>">
                  </div>
